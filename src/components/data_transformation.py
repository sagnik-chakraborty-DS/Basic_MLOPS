...
class DataTransformation:
    def __init__(self):
        self.DataTrasformationConfig = DataTrasformationConfig()
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Numerical column scalar completed")
            logging.info("Categorical column encodeing completed")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            save_object(
                ...
                file_path=self.DataTrasformationConfig.preprocessor_obj_file_path,
            ...
            return (
                train_arr,
                test_arr,
                self.DataTrasformationConfig.preprocessor_obj_file_path,
            )
        except Exception as e:
         raise CustomException(e, sys)   
